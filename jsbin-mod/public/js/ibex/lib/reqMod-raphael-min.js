...
// └────────────────────────────────────────────────────────────────────┘ \\
!function (a, b) {
  "function" == typeof def && def.amd ? def("eve", function () {
    return b()
  ...
  "function" == typeof def && def.amd ? def("raphael.core", ["eve"], function (a) {
    return b(a)
  }) : "object" == typeof exports ? module.exports = b(req("eve")) : a.Raphael = b(a.eve)
}(this, function (a) {
  function b(c) {
  ...
  var eb = b.easing_formulas = {
    linear: function (a) {
      ...
      return a == !!a ? a : Q(2, -10 * a) * M.sin((a - .075) * (2 * R) / .3) + 1
    }, bounce: function (a) {
  ...
  "function" == typeof def && def.amd ? def("raphael.svg", ["raphael.core"], function (a) {
    return b(a)
  }) : b("object" == typeof exports ? req("./raphael.core") : a.Raphael)
}(this, function (a) {
  if (!a || a.svg) {
    ...
    var q = function (d, e) {
      ...
      if (s())return "url('#" + a + "')";
      var b = document.location, c = b.protocol + "//" + b.host + b.pathname + b.search;
      return "url('" + c + "#" + a + "')"
    }, u = function (a) {
      var b = a.getBBox(1);
      ...
      for (var o in f)if (f[b](o)) {
        ...
        switch (k[o] = p, o) {
          ...
          case"stroke":
            H = a.getRGB(p), i.setAttribute(o, H.hex), "stroke" == o && H[b]("opacity") && q(i, {"stroke-opacity": H.opacity > 1 ? H.opacity / 100 : H.opacity}), "stroke" == o && d._.arrows && ("startString" in d._.arrows && v(d, d._.arrows.startString),
            "endString" in d._.arrows && v(d, d._.arrows.endString, 1));
            break;
          case"gradient":
    ...
    C.prototype = D, D.constructor = C, a._engine.path = function (a, b) {
      ...
      if (this.removed || !b)return this;
      var c = B(this.node), d = B(b.node || b[0].node);
  ...
  "function" == typeof def && def.amd ? def("raphael.vml", ["raphael.core"], function (a) {
    return b(a)
  }) : b("object" == typeof exports ? req("./raphael.core") : a.Raphael)
}(this, function (a) {
  if (!a || a.vml) {
  ...
  if ("function" == typeof def && def.amd)def("raphael", ["raphael.core", "raphael.svg", "raphael.vml"], function (c) {
    return a.Raphael = b(c)
  }); else if ("object" == typeof exports) {
    var c = req("raphael.core");
    req("raphael.svg"), req("raphael.vml"), module.exports = b(c)
