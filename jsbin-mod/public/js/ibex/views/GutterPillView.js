def([
  ...
  return Backbone.View.extend({
    ...
    expandTrace: function (e) {
      if (!this.$activeLine && !this.htmlRelatedNodeModels) {
        ...
        var invokes = this.activeNodeModel.get("invokes");
        if (invokes) {
          this.renderStackView(invokes);
        }
      }
    ...
    renderStackView: function (invokes) {
      _(invokes).each(function (invocation, i) {
